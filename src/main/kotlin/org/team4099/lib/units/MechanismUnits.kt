...
interface MechanismSensor<U : UnitKey> {
  ...
  fun proportionalPositionGainToRawUnits(proportionalGain: ProportionalGain<U, Volt>): Double

  fun integralPositionGainToRawUnits(integralGain: IntegralGain<U, Volt>): Double

  fun derivativePositionGainToRawUnits(derivativeGain: DerivativeGain<U, Volt>): Double

  fun proportionalVelocityGainToRawUnits(
      proportionalGain: ProportionalGain<Velocity<U>, Volt>
  ): Double

  fun integralVelocityGainToRawUnits(integralGain: IntegralGain<Velocity<U>, Volt>): Double

  fun derivativeVelocityGainToRawUnits(derivativeGain: DerivativeGain<Velocity<U>, Volt>): Double
...
class LinearMechanismSensor(
  ...
  override inline fun integralPositionGainToRawUnits(
    ...
    return (integralGain.inVoltsPerMeterSeconds /
  ...
  override inline fun derivativePositionGainToRawUnits(
    ...
    return (derivativeGain.inVoltsPerMeterPerSecond *
  ...
  override inline fun integralVelocityGainToRawUnits(
    ...
    return (integralGain.inVoltsPerMeters /
        (velocityToRawUnits(1.meters.perSecond) *
            timescale.pidTimeConversion(timescale.velocity))) / compensationVoltage.inVolts *
        fullPowerThrottle
  }
  ...
  override inline fun derivativeVelocityGainToRawUnits(
    ...
    return (derivativeGain.inVoltsPerMetersPerSecondPerSecond *
...
class AngularMechanismSensor(
  ...
  override inline fun integralPositionGainToRawUnits(
    ...
    return (integralGain.inVoltsPerRadianSeconds /
  ...
  override inline fun derivativePositionGainToRawUnits(
    ...
    return (derivativeGain.inVoltsPerRadianPerSecond *
  ...
  override inline fun proportionalVelocityGainToRawUnits(
    ...
    return (proportionalGain.inVoltsPerRadiansPerSecond /
        (velocityToRawUnits(1.radians.perSecond))) / compensationVoltage.inVolts * fullPowerThrottle
  }

  override inline fun integralVelocityGainToRawUnits(
      integralGain: IntegralGain<Velocity<Radian>, Volt>
  ): Double {
    return (integralGain.inVoltsPerRadians /
  ...
  override inline fun derivativeVelocityGainToRawUnits(
    ...
    return (derivativeGain.inVoltsPerRadiansPerSecondPerSecond *
